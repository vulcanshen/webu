...
//
// The family's key is V. In webu V is visual mode wherever there is a page
// to walk, so the egg is on V where there is none: on the web screen with
// no page shown, and on the Bookmarks, History, Downloads and Settings
// screens (ux.md §A.2).
...
// U = navy frame; the gold mark spells WEB, one letter per code.
var logoPixels = [21]string{
	"DDDDDDDDDDDDDDDDDDDDDDDDD",
	"DDUUUDDDDDDDDDDDDDDDUUUDD",
	"DDDUUDWDWDWDEEEDBBBDUUDDD",
	"DDDUUDWDWDWDEDDDBDBDUUDDD",
	"DDDUUDWDWDWDEDDDBDBDUUDDD",
	"DDDUUDWDWDWDEDDDBDBDUUDDD",
	"DDDUUDWDWDWDEDDDBDBDUUDDD",
	"DDDUUDWDWDWDEDDDBDBDUUDDD",
	"DDDUUDWDWDWDEDDDBBBDUUDDD",
	"DDDUUDWDWDWDEEEDBDDDUUDDD",
	"DDDUUDWDWDWDEDDDBBBDUUDDD",
	"DDDUUDWDWDWDEDDDBDBDUUDDD",
	"DDDUUDWDWDWDEDDDBDBDUUDDD",
	"DDDUUDWDWDWDEDDDBDBDUUDDD",
